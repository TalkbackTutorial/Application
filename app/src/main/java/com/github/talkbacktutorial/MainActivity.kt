...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        this.lesson1Card.setOnClickListener {
            if (this.lessonsModel.lesson2Locked.value!!) this.ttsEngine.speak("Lesson 2 unlocked")
            this.lessonsModel.lesson2Locked.value = false
        }
        this.lesson2Card.setOnClickListener {
            if (this.lessonsModel.lesson3Locked.value!!) this.ttsEngine.speak("Lesson 3 unlocked")
            this.lessonsModel.lesson3Locked.value = false
        }
        this.lesson3Card.setOnClickListener {
            if (this.lessonsModel.lesson4Locked.value!!) this.ttsEngine.speak("Lesson 4 unlocked")
